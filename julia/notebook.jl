...
# ╔═╡ fe340d75-f468-4e42-9a1c-e7164a1f0070
using Combinatorics

# ╔═╡ 9449376b-dcac-471b-94b3-39aa726af7dc
using Statistics

# ╔═╡ 5db5b34c-50bf-4c3b-b26d-09fb96078bf6
using HypothesisTests

# ╔═╡ d08c05ac-7ed2-4021-a69a-f1db2cd01b2f
using Distributions
...
# ╔═╡ 4fbccd38-3b59-4441-abcc-7f86f61f3301
d = Distributions.Normal()

# ╔═╡ 7f93a484-a58d-45e6-b748-e101d124420c
n1, n2 = 12, 8

# ╔═╡ 11a4bf6a-f3ef-4ce1-82fe-937c8ce88485
Random.seed!(123); x1 = rand(d, n1); x2 = rand(d, n2)

# ╔═╡ 623891f2-bbe7-4a86-b9dc-1e5197efd80b
delta = 0

# ╔═╡ 19a357f0-251b-4033-99b0-ea602c3fccbd
parts = partition(n1, n2)

# ╔═╡ 4205e09e-00cc-4c90-aef6-7db20f0a6dcf
ttest = EqualVarianceTTest(x1 .- delta, x2)
